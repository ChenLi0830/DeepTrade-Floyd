...
def coin_market_error(y_true, y_pred):
    # K.cast(True, 'float32') == 0.0, K.cast(False, 'float32') == 1.0
    # return 10000. * K.mean(K.square(y_pred - y_true) * (1. + 2 * K.cast(K.greater(y_pred * y_true, 0), 'float32')))
    return 10000. * K.mean(K.square(y_pred - y_true), axis=-1)
